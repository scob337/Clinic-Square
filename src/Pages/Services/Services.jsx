...
export default function Services() {
  ...
  return (
    <div className="w-full min-h-[70vh] p-3  ">
      <div className="flex justify-center w-full gap-3 flex-wrap">
        <button
          className={`min-w-[100px] ring-1 ring-[#00ACA8] text-[#00aca8] rounded-lg p-2 font-semibold w-fit hover:bg-[#00aca8] hover:text-white transition ${
            Active === "BMI" ? " bg-[#00ACA8]   text-white" : ""
          }`}
        ...
        <button
          className={`min-w-[100px] ring-1 ring-[#00ACA8] text-[#00aca8] rounded-lg p-2 font-semibold w-fit hover:bg-[#00aca8] hover:text-white transition ${
            Active === "Period" ? " bg-[#00ACA8]   text-white" : ""
          }`}
        ...
        <button
          className={`min-w-[100px] ring-1 ring-[#00ACA8] text-[#00aca8] rounded-lg p-2 font-semibold w-fit hover:bg-[#00aca8] hover:text-white transition ${
            Active === "Pregnancy" ? " bg-[#00ACA8]   text-white" : ""
          }`}
        ...
        <button
          className={`min-w-[100px] ring-1 ring-[#00ACA8] text-[#00aca8] rounded-lg p-2 font-semibold w-fit hover:bg-[#00aca8] hover:text-white transition ${
            Active === "Calorie" ? " bg-[#00ACA8]   text-white" : ""
          }`}
