    ...
    const calculateCalories = () => {
        const heightInCm = height; // الطول بالمتر يمكن تحويله إلى متر لتوضيح المدى المناسب
        let BMR;
        if (gender === "male") {
    ...
    return (
        <CalcLayout Title={"Calorie CALCULATOR"}>
        <div className="flex flex-col">
            ...
            <h1 className="font-bold text-lg mb-3">GENDER</h1>
            ...
            <div
            className="w-[60%] max-sm:w-[70%] mt-10 bg-[#D9D9D980] max-w-[400px] h-[150px] m-auto p-5 rounded-md flex flex-col gap-3 relative
                text-center"
            >
            <h1 className=" font-bold text-[36px[">HEIGHT</h1>
            ...
            <input
                className="w-full h-2 bg-gray-300 rounded-lg text-[#00ACA8] 
                    appearance-auto 
                    cursor-pointer range-slider relative z-10"
                type="range"
                step={1}
                min={100}
                max={250}
